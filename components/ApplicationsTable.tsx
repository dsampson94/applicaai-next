            ...
            <div className="overflow-auto max-h-[80vh]">
                <table className="min-w-full bg-white">
                    ...
                    { applications.map((jobApplication) => (
                        <tr key={ jobApplication._id.toString() } className="hover:bg-gray-100">
                            ...
                            <td className="border px-4 py-2 max-w-[150px] truncate">
                                { jobApplication.jobSpecName ? (
                                    <a
                                        href={ jobApplication.jobSpecUrl }
                                        target="_blank"
                            ...
                            <td className="border px-4 py-2 max-w-xs">
                                <div className="flex flex-wrap">
                                    { jobApplication.tags?.map((tag: string) => (
                                        <span key={ tag }
                                              className="bg-blue-100 text-blue-800 rounded-full px-3 py-1 mr-2 mb-2">{ tag }</span>
                                    )) }
                                </div>
                            </td>
                            <td className="border px-4 py-2 max-w-xs">
